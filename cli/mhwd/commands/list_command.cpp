...
{
    auto installed_result = provider_.get_installed_configs(type);
    auto available_result = provider_.get_available_configs(type);
    ...
    auto matching_configs = provider_.find_matching_configs(type);
